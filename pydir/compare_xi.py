...
def usage():
    ...
    print '   -c, --QCD     : turn pythia hard QCD processes on'
    print '   -q, --QED     : turn pythia hard QED processes off'
...
#   Parse command line and set defaults (see http://docs.python.org/library/getopt.html)
    try:
        opts, args = getopt.getopt(sys.argv[1:], 'htf:e:n:x:s:cqm:p:b:', \
              ['help','trento','file=','eCM=','pTHatMin=','pTHatMax=','seed=','QCD','QED','num_events=','pTjetMin=','bins='])
